...
class SkipGramModel:
    ...
    def _create_embedding(self):
        """ Step 2: define weights. In word2vec, it's actually the weights
        that we care about """
...
def train_model(model, batch_gen, num_train_steps, weights_fld):
    # default to saving all variables - in this case embed_matrix,
    # nce_weight, nce_bias
    ...
    with tf.Session(config=config) as sess:
        ...
        # we use this to calculate late average loss in the last SKIP_TEST steps
        total_loss = 0.0
